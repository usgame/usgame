...
namespace USGame
{
    public static class ZlibHelper
    {
        ...
        public static byte[] CompressBytes(byte[] OrgByte, int CompressRate = zlibConst.Z_DEFAULT_COMPRESSION)
        {
        ...
        #region DecompressBytes 对原始字节数组进行zlib解压缩，得到处理结果字节数组
        /// <summary>
        /// 对原始字节数组进行zlib解压缩，得到处理结果字节数组
        /// </summary>
